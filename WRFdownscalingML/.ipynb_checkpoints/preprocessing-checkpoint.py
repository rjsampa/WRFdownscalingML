...
class DataBase:
    ...
    def get_var_din(self, name, range=None):
        """
        ...
        if range is None:
            ...
            self.var = self.wrfoutput.variables[name][range[0]:range[1]]
    ...
    def get_var_static(self,name):
        ...
        get static variable 
        """
        self.lat = self.wrfoutput.variables[name][1]
    ...
    def plot(self,campo, water_mask=True):
        plot_map(campo,lat=self.lat,lon=self.lon, mask_water=water_mask, lulc=self.lulc)
